...
<body bgcolor="${bodyback_c}">
	<div align="center">
		...
		<form method="post" name="writeForm" action="/teamPro03/board/writePro.do"
			...
			<table width="400" border="1" cellpadding="0" cellspacing="0"
				...
				<tr>
					<td align="right" colspan="2" bgcolor="${value_c}"><a
						href="/teamPro03/board/list.do">글목록</a></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width="330"><c:if test="${num eq 0}">
							<input type="text" size="40" maxlength="50" name="subject">
						</c:if> <c:if test="${num ne 0}">
							<input type="text" size="40" maxlength="50" name="subject"
								value="[답변]">
						</c:if></td>
				</tr>
				...
				<tr>
					<td colspan="2" bgcolor="${value_c}" align="center"><input
						...
						onClick="window.location='/teamPro03/board/list.do'"></td>
				</tr>
			</table>
		</form>
	</div>
