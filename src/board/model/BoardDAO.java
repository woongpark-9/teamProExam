...
public class BoardDAO { // 실제 DB 쿼리 작업을 해 줄 DAO
	private static BoardDAO instance = null;

	private BoardDAO() {
	}

	public static BoardDAO getInstance() { // 싱글턴 패턴 적용
		if (instance == null) {
	...
	public List<BoardVO> getArticles(int start, int end) { // 글 목록을 얻어 와서 List 형태로 리턴해 줄 메소드
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public void insertArticle(BoardVO article) { // 글 저장을 처리해줄 메소드
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public BoardVO getArticle(int num) { // 데이터베이스에서 실제로 글 내용을 가져올 메소드
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public BoardVO updateGetArticle(int num) { // 수정하려고 하는 글의 세부 데이터를 받아올 메소드
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		BoardVO article = null;
	...
	public int updateArticle(BoardVO article) { // 글 수정처리를 실제로 데이터베이스에 적용시켜줄 메소드
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String dbpasswd = "";
	...
	public int deleteArticle(int num, String pass) { // 실제로 데이터베이스에서 게시물을 삭제해 줄 메소드
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String dbpasswd = "";
